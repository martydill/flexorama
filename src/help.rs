...
pub fn print_hooks_help() {
    ...
    app_println!("  Hooks are configured in hooks.json:");
    app_println!("  • ~/.flexorama/hooks.json    (global)");
    app_println!("  • .flexorama/hooks.json      (project)");
    app_println!();
    app_println!("{}", "Example hooks.json:".green().bold());
    app_println!(r#"  {{"#);
